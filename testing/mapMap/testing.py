...
# Configuration
DATALOG_FILE = '/home/elena/Documents/SouffleCRDTs/crdts/awset.dl'   # change if your top-level DL file is named differently
OUTPUT_RELATION_FILE = 'setState.csv'  # Name of output relation file Soufflé writes
