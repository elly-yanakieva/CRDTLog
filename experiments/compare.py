...
TESTS_DIR = Path("/home/elena/Documents/Exps/manual/tests10_1000")          # contains 1..1000
RESULTS_DIR = Path("manual/test_results10_1000")  # will be created
...
def main():
    ...
    for i in range(1, NUM_TESTS + 1):
        ...
        if all_ok:
            ...
            # 🔥 CLEANUP: remove all per-test outputs on success
