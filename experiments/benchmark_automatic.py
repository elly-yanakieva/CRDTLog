...
TESTS_DIR = Path("/home/elena/Documents/Exps/scale_ops/automatic/tests4_1000")
...
RESULTS_DIR = Path("scale_ops/automatic/") / results_name
...
def main():
    ...
    for i in range(1, NUM_TESTS + 1):
        ...
        print(f"[{i}/{NUM_TESTS}] Running test {test_in}", flush=True)
        ...
        if ok1:
            ...
            graph_ok += 1
            print(f"CRDT graph took {t_graph} seconds")
        else:
        ...
        if ok2:
            ...
            abstract_ok += 1
            print(f"abstract graph took {t_abs} seconds")
